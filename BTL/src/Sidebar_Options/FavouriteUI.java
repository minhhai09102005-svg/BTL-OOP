...
public class FavouriteUI extends StackPane {                                            // [OLD]
    ...
    private static final ObservableList<Song> DATA = FXCollections.observableArrayList(); // [OLD]

    /** Gọi khi toggle ♥ ở bất kỳ đâu */
    public static void onFavouriteToggled(Song s) {                                     // [OLD]
        if (s == null) return;                                                          // [OLD]
        if (s.isFavourite()) {                                                          // [OLD]
            if (!DATA.contains(s)) DATA.add(s);                                         // [OLD]
        } else {
            DATA.remove(s);                                                             // [OLD]
        }
    }
    ...
    public static ObservableList<Song> items() { return DATA; }                         // [OLD]
    ...
    private Region makeRow(int index, Song song) {                                       // [OLD]
        ...
        play.setOnAction(e -> controller.play(song));                                     // [OLD]
        ...
        row.setOnAction(e -> controller.play(song));                                                         // [OLD]
